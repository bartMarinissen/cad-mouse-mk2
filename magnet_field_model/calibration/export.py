...
def format_cpp(geometry: BundleGeometry) -> str:
    ...
    Config::defaultCalibration() and meant to be placed in firmware/src/Config.cpp,
    assigning each firmware/include/CalibrationParams.h field in turn - a
    plain function rather than an aggregate initializer, since designated
    initializers are C++20 and this firmware does not require that standard.
